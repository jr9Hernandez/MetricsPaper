...
public class DataRecorder {
	...
	public void fireKillRecord(Sprite sprite){
		killRecord(sprite);
		fireKills++;
		//System.out.println(" fire kill " + fireKills);
	}

	public void shellKillRecord(Sprite sprite){
		killRecord(sprite);
		shellKills++;
		//System.out.println(" shell kill " + shellKills);
	}

	public void killSuicideRecord(Sprite sprite){
		killRecord(sprite);
		suicideKills++;
		//System.out.println(" suicide " + suicideKills);
	}

	public void killStompRecord(Sprite sprite){
		killRecord(sprite);
		stompKills++;
		//System.out.println(" stomp " + stompKills);
	}
	...
	public void killRecord(Sprite sprite){
		...
		if(sprite instanceof FlowerEnemy){
			...
			/*
			System.out.print("\nInimigo morto: " + enemy.type + ": ");
			switch (enemy.type) {
				case 0:
					System.out.println("ENEMY_RED_KOOPA\n");
					break;
				case 1:
					System.out.println("ENEMY_GREEN_KOOPA\n");
					break;
				case 2:
					System.out.println("ENEMY_GOOMBA\n");
					break;
				case 3:
					System.out.println("ENEMY_SPIKY\n");
					break;
				case 4:
					System.out.println("ENEMY_FLOWER\n");				
				break;			
			}
			*/
			kills[enemy.type]++;
	...
	public void fillGamePlayMetrics(RandomLevel level){
		...
		//System.out.println("Salvando o aquivo GamePlay!");
