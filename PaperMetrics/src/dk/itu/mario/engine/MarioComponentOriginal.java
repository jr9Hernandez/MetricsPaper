...
public class MarioComponentOriginal extends JComponent implements Runnable,
	...
	public MarioComponentOriginal(int width, int height, boolean isCustomized) {
	...
	public void toRandomGame() {
		/*Trecho de c�digo deve ser descomentado
...
//		}
		...
		try{
			...
			System.out.println("Dê uma avaliação para essa fase [0-10]: ");
			this.levelResult = s.nextInt();

			b.write("Nota: " + Integer.toString(this.levelResult) + '\n');

		} catch (InputMismatchException e) {
			System.err
					.println("Você inseriu a nota incorretamente. Digite um valor inteiro entre 0 e 10!");
			this.showFinalTestInterface();
