...
public class PetLevelGenerator implements LevelGenerator {
	...
	public LevelInterface generateLevel(GamePlay playerMetrics) {
		...
		try {
			...
			level = (LevelInterface) new LevelMap(file, 40, 15, FileHandlingType.SAVE);
		}
		catch (Exception e)
		{
			System.err.print("Nao foi possivel criar a fase: ");
			System.err.print(e.getMessage());
			level = (LevelInterface) new LevelMap (40,15);
		}
