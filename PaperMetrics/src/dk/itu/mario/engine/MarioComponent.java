...
import br.ufv.dpi.FormularioAvaliacaoTelas;
import br.ufv.dpi.FormularioComparacaoFases;
import br.ufv.dpi.FormularioFinal;
import br.ufv.dpi.FormularioPosTeste;
import br.ufv.dpi.TelaB;
...
public class MarioComponent extends JComponent implements Runnable, KeyListener, FocusListener, MouseListener
	{
		    ...
		    private JFrame game;
		    private JFrame form;
		    private FormularioFinal form2;

		    private Scale2x scale2x = new Scale2x(320, 240);

		    private double openTime;

		    public void setJFrames(JFrame game, JFrame form)
		    {
		    	this.game = game;
		    	this.form2 = (FormularioFinal) form;
		    }
		    
		    public void setJFrames(ArrayList<JFrame> form)
		    {
		    	this.game = form.get(0);
		    	this.form = form.get(1);
		    	this.form2 = (FormularioFinal)form.get(2);
		    	form2.setJFrames(this.form);
		    }
		    ...
		    public void toRandomGame(){
		    	...
		    	randomLevel = new LevelSceneTest(graphicsConfiguration,this,new Random().nextLong(),5,0,false);
		    ...
		    public void lose(){
		    	...
		    	*/
		    	...
		    	if(VariaveisGlobais.testando){
		    		...
		    		VariaveisGlobais.testando = false;
		    	}		    		
		    	else
		    		...
		    		//FormularioAvaliacaoTelas.main(null);
		    		FormularioFinal.main(null);
		    		//FormularioComparacaoFases.main(null);
