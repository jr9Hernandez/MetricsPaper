 ...
 *
 */
public class FormularioInicialAvaliadorTelas extends JFrame implements ActionListener{

	public FormularioInicialAvaliadorTelas(){
	...
	public static void main(String [] args){
		...
		new FormularioInicialAvaliadorTelas().setVisible(true);
