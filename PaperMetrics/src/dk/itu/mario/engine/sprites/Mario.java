    ...
    public void move()
    {
    	if(deathTime == 0 && winTime == 0){
	        if (keys[KEY_DOWN] && large && ducking)
	        {
	            if(world.recorder != null && world.recorder.recording)
	            	...
	            	if(world.recorder2 != null && world.recorder2.recording)
		            	world.recorder2.startDuckRecord();
	        }
	        else
	        {
	            if(world.recorder != null && world.recorder.recording && !ducking)
	            	...
	            	if(world.recorder2 != null && world.recorder2.recording && !ducking)
		            	world.recorder2.endDuckRecord();
	        }
    	}
        ...
        if(deathTime == 0 && winTime == 0){
	    	if(keys[KEY_SPEED]){
	    		if(world.recorder!= null && world.recorder.recording){
	    			...
	    			if(world.recorder2!= null && world.recorder2.recording){
		    			world.recorder2.startRunningRecord();
		    		}
	    		...
	    		if(world.recorder!= null && world.recorder.recording){
	    			...
	    			if(world.recorder2!= null && world.recorder2.recording){
		    			world.recorder2.endRunningRecord();
		    		}
        ...
        if (onGround)
        {
            ...
            if(world.recorder != null)
            	...
            	if(world.recorder2 != null)
                	world.recorder2.recordJumpLand();
        }
        ...
        if (keys[KEY_JUMP] || (jumpTime < 0 && !onGround && !sliding))
        {
            ...
            else if (onGround && mayJump)
            {
                ...
                if(world.recorder != null){
                	...
                	if(world.recorder2 != null){
                    	world.recorder2.isInAir = true;
                    	world.recorder2.recordJump();
                    }
            }
...
//        			world.recorder.switchRecord();
        			...
        			if(world.recorder2 != null){
//            			world.recorder.switchRecord();
            			world.recorder2.startRightMoveRecord();
            		}
        	}
...
//        			world.recorder.switchRecord();
        			...
        			if(world.recorder2 != null){
//        				world.recorder.switchRecord();
        				world.recorder2.startLeftMoveRecord();
        			}
        	}
        	...
        	//was moving left
        		...
        		if(direction == 1 && world.recorder2!= null){
            		world.recorder2.endRightMoveRecord();
            	}
            	//was moving left
            	else if(direction == -1 && world.recorder2!= null){
            		world.recorder2.endLeftMoveRecord();
            	}
...
//        if(x > world.level.xExit * 16 && ! world.level.flipped || x < world.level.xExit * 16 && world.level.flipped )
        ...
        if (carried != null)
        {
            ...
            if (!keys[KEY_SPEED])
            {
                ...
                if(world.recorder != null){
                	...
                	if(world.recorder2 != null){
                    	world.recorder2.shellUnleashedRecord();
                    }
            }
        }
    }
    ...
    public void stomp(Enemy enemy)
    {
        ...
        if(world.recorder!=null)
	        ...
	        if(world.recorder2!=null)
	        	world.recorder2.killStompRecord(enemy);
    }
    ...
    public void stomp(Shell shell)
    {
        ...
        else
        {
            ...
            if(shell.xa == 0 && world.recorder!= null){
            	...
            	if(shell.xa == 0 && world.recorder2!= null){
                	world.recorder2.shellUnleashedRecord();
                }
            }
        }
        ...
        if (large)
        {
            ...
            if (fire)
            {
                ...
                if(world.recorder != null){
                	...
                	if(world.recorder2 != null){
                    	world.recorder2.endFireRecord();
                    	world.recorder2.startLargeRecord();
                    }
                }
            }
            else
            {
                ...
                if(world.recorder != null){
                	...
                	if(world.recorder2 != null){
                    	world.recorder2.endLargeRecord();
                    	world.recorder2.startLittleRecord();
                    }
            }
            invulnerableTime = 32;
        }
    ...
    public void dieSprite(Sprite sprite){
		...
		if(world.recorder != null){
			...
			if(world.recorder2 != null){
				world.recorder2.dieRecord(sprite);
			}
    }
    ...
    public void die()
    {
        ...
        if(world.recorder != null){
        	...
        	if(world.recorder2 != null){
            	...
            	if(!large && !fire)
            		world.recorder2.endLittleRecord();

            	if(ducking)
            		world.recorder2.endDuckRecord();

            	world.recorder2.endTime();
            	world.recorder2.recordJumpLand();
            }
        }
        ...
        if (!fire)
        {
            ...
            if(world.recorder != null){
            	...
            	if(world.recorder2 != null){
    	            ...
    	            world.recorder2.startFireRecord();
                }
            }
        }
        else
    ...
    public void stomp(BulletBill bill)
    {
        ...
        if(world.recorder!=null)
        	world.recorder.killStompRecord(bill);
        	 ...
        	 if(world.recorder2!=null)
             	world.recorder2.killStompRecord(bill);
    }
